<?php /* Smarty version Smarty-3.1.8, created on 2021-03-31 19:22:44
         compiled from "/home/ejercitomil/public_html/_templates/DEFAULT2018/templates/tpl_subMenuGaleriaMulti.html" */ ?>
<?php /*%%SmartyHeaderCode:209250301960347feb066115-14503038%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7cced24708990e4d2cb11a2c3af3b2e2fa889ba5' => 
    array (
      0 => '/home/ejercitomil/public_html/_templates/DEFAULT2018/templates/tpl_subMenuGaleriaMulti.html',
      1 => 1617199326,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '209250301960347feb066115-14503038',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_60347feb15c163_32353382',
  'variables' => 
  array (
    'flgimage' => 0,
    'flgvideo' => 0,
...
<?php if ($_valid && !is_callable('content_60347feb15c163_32353382')) {function content_60347feb15c163_32353382($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/home/ejercitomil/public_html/_lib/smarty/libs/plugins/modifier.truncate.php';
?>
	<style>
			...
			<?php if ($_smarty_tpl->tpl_vars['sub']->value['selector']==3){?>
				<table>
					<tr style="background-position:center;text-aling:center"><!--align="center"-->
						<td class="titulom"><strong><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['sub']->value['nombre'],64,"...",true);?>
</strong></td>
					</tr>
					<?php if ($_smarty_tpl->tpl_vars['sub']->value['entradilla']!=''){?>
						<tr style="background-position:center;text-aling:center">
							<td class="textom" ><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['sub']->value['entradilla'],128,"...",true);?>
</td>
						</tr>
					<?php }?>
					<tr style="background-position:center;text-aling:center">
...
')"><?php echo @_ROT_VER_VIDEO;?>
							...
							<a class="enlacem" onkeypress="window.status = 'Ejecutar Archivo';" onClick="window.status = 'Ejecutar Archivo';" href="javascript:playVideo('<?php echo @_URL;?>
','<?php echo $_smarty_tpl->tpl_vars['sub']->value['archivo'];?>
...
" alt="archivo"/>
					...
					<tr>
						<td class="textom" ><!--Comentario de la imagen-->
							<a class="enlacem" href="?idcategoria=<?php echo $_smarty_tpl->tpl_vars['sub']->value['idcategoria'];?>
...
')"							
					...
					<tr style="background-position:center;text-aling:center"><!--align="center"-->
						<td class="textom" >
							<a class="enlacem" onkeypress="window.status = 'Descargar Archivo';" onClick="window.status = 'Descargar Archivo';" href="<?php echo $_smarty_tpl->tpl_vars['sub']->value['archivo'];?>
