<?php /* Smarty version Smarty-3.1.8, created on 2021-02-19 19:20:37
         compiled from "/home/ejercitomil/public_html/_templates/Subsitio2018/templates/tpl_lateral_derecho.html" */ ?>
<?php /*%%SmartyHeaderCode:1019909098602e5ef3728969-52789770%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'df57e514593ef8cbf68b4c33346a93a9c397c8e0' => 
    array (
      0 => '/home/ejercitomil/public_html/_templates/Subsitio2018/templates/tpl_lateral_derecho.html',
      1 => 1613762436,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1019909098602e5ef3728969-52789770',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_602e5ef3790616_15543680',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_602e5ef3790616_15543680')) {function content_602e5ef3790616_15543680($_smarty_tpl) {?><div class="row tabla_lateral1" style="">
	
	<div class="col-md-12 col-lg-12" id="destacados-lateral" style="height: 759px;">
		<div class="slide slide-destacados alto_contraste col-sm-12" style="height: 250px;">
			<div class="row" >
		...
		<div class="slide slide-destacados alto_contraste col-sm-12" style="height: 250px;">
			<div class="row">
				<a href="https://www.ejercito.mil.co/informes_noticias/enterese_proceso_paz">
					<div class="fonfo_destacado-lateral">
						<div class="" style="width:100%;"></div>
						<div class="img_dest2" style="height: 190px; width:250px;background-size: cover;"></div>
						<div style="background-color: white;margin-top:-10px;padding-top:10px;">
						<div class="" style="background-color: #862024;height: 3px;width: 200px;margin-top:10px;margin-left: 20px;"></div>
		...
		<div class="slide slide-destacados alto_contraste col-sm-12" style="height: 250px;">
			<div class="row">
				<a href="https://www.ejercito.mil.co/informes_noticias/habla_comandante">
					<div class="fonfo_destacado-lateral">
						<div class="" style="width:100%;"></div>
						<div class="img_dest3" style="height: 190px; width:250px;background-size: cover;"></div>
						<div style="background-color: white;margin-top:-10px;padding-top:10px;">
						<div class="" style="background-color: #862024;height: 3px;width: 200px;margin-top:10px;margin-left: 20px;"></div>
		...
		<div class="slide slide-destacados alto_contraste col-sm-12" style="height: 250px;">
			<div class="row">
				<a href="https://www.clublancita.mil.co/" target="_blank">
					<div class="fonfo_destacado-lateral">
						<div class="" style="width:100%;"></div>
						<div class="img_dest6" style="height: 190px; width:250px;background-size: cover;"></div>
						<div style="background-color: white;margin-top:-10px;padding-top:10px;">
						<div class="" style="background-color: #862024;height: 3px;width: 200px;margin-top:10px;margin-left: 20px;"></div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
		  ...
		  $('#destacados-lateral').slick({
		    ...
		    nextArrow: '<div class="slick-next right-slide-lateral" style="margin-top: 25px;"></div>',
