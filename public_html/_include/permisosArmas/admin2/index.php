...
.Estilo5 {font-family: "Berlin Sans FB"}
...
function valida_envia(){ 
    ...
    if (document.fvalida.nombre.value.length==0){ 
       ...
       alert("Nombre del representante legal.") 
    ...
    <tr>
      ...
      <td colspan="4" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="528" height="30" align="center" valign="middle" bgcolor="#996600"><span class="Estilo3"><strong><font color="#FFFFFF">:::...</font></strong> <strong><font color="#FFFFFF" face="Arial, Helvetica, sans-serif">ESCR&Iacute;BALE

            AL COMANDANTE</font></strong> <font color="#FFFFFF"><strong>...:::</strong></font><font color="#FFFFFF"><strong></strong></font></span></td>

          </tr>

          <tr>

            <td height="60"><form name="form1" method="post" action="login.php">
              <table width="61%"  border="0" cellpadding="1" bgcolor="#FFFFFF">
                <tr>
                  <td width="27%" bgcolor="#F0F0DB">Usuario</td>
                  <td width="73%" bgcolor="#F0F0DB"><div align="center">
                      <input name="usuario" type="text" class="Estilo5" id="usuario" onChange="javascript:this.value=this.value.toUpperCase();">
                  </div></td>
                </tr>
                <tr>
                  <td bgcolor="#F0F0DB">Password</td>
                  <td bgcolor="#F0F0DB"><div align="center">
                      <input name="password" type="password" class="Estilo5" id="password" onChange="javascript:this.value=this.value.toUpperCase();">
                  </div></td>
                </tr>
              </table>
              <div align="right"></div>
