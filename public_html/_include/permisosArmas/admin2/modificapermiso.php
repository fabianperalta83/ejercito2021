...
if (document.fvalida.id.value.length==0)
	  { 
       alert("Tiene que escribir el No de identificacion") 
       document.fvalida.id.focus() 
       return 0; 
	   }
if (document.fvalida.nopermiso.value.length==0)
	  { 
       alert("Tiene que escribir el No del permiso") 
       document.fvalida.nopermiso.focus() 
       return 0; 
	   }	   	   
