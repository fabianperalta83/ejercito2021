...
if(isset($_SESSION['info_usuario']))
{
	if($_SESSION['info_usuario']['idzona'] == 9 || $_SESSION['info_usuario']['idzona'] == 2)
	{
		...
		$constantes_permitidas['constante'] =   '_IMAGEN_BANNER_PRINCIPAL';
		$constantes_permitidas['constante'] =   '_IMAGENES';
		
		 $constantes_permitidas['constante'] =   '__TRANSPARENCIA';
		 $constantes_permitidas['constante'] =   '__OBRAS';
		 $constantes_permitidas['constante'] =   '__ATENCIONDESASTRE';
		 $constantes_permitidas['constante'] =   '__AMBIENTAL';
		 $constantes_permitidas['constante'] =   '__DESMINADO';
		...
		*/
		...
		{
		    if($datos['n']=='_IMAGEN_BANNER_PRINCIPAL')
			{
		...
		if(isset($_POST['guardar']))
		{
			...
			$resultado_actualizacion	=	$db->Execute($actualizacion) or errorQuery(__LINE__, __FILE__);;
		}
